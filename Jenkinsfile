  ...
  stages {
      ...
      parallel {
        ...
        stage('build-product-service') {
          steps {
            ...
            cobertura(coberturaReportFile: 'product-service/api/target/site/cobertura/coverage.xml', conditionalCoverageTargets: '70, 0, 0', lineCoverageTargets: '80, 0, 0', methodCoverageTargets: '80, 0, 0', sourceEncoding: 'ASCII')
    ...
    stage('deploy-test') {
      ...
      steps {
        ...
        kubernetesDeploy(configs: 'kompose/test/*', kubeConfig: [path: ''], kubeconfigId: 'creds-test-k8s', secretName: 'regcred', secretNamespace: 'boathouse-dev', ssh: [sshCredentialsId: '*', sshServer: ''], textCredentials: [certificateAuthorityData: '', clientCertificateData: '', clientKeyData: '', serverUrl: 'https://'])
      }
    }
    ...
    stage('deploy-production') {
      ...
      steps {
        ...
        kubernetesDeploy(configs: 'kompose/prod/*', kubeConfig: [path: ''], kubeconfigId: 'creds-test-k8s', secretName: 'regcred', secretNamespace: 'boathouse-prod', ssh: [sshCredentialsId: '*', sshServer: ''], textCredentials: [certificateAuthorityData: '', clientCertificateData: '', clientKeyData: '', serverUrl: 'https://'])
      }
    }
